...
{
$query = $this->db->prepare("SELECT * FROM posts WHERE Id = '$f'  ORDER BY postID DESC LIMIT 5");
...
{
	$query = $this->db->prepare("SELECT * FROM `gallery` where Id ='$f'");
...
{
	$query = $this->db->prepare("SELECT Id FROM `teams` where Team ='$sport'");
