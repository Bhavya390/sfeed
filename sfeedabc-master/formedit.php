                ...
                <div class="col-sm-2 col-md-2 col-xs-12 heading">
                  ...
                  <div id="divmsg" style="display: none;" class="col-sm-7 col-md-5 col-xs-12 col-md-offset-2 hidden-xs">
                    <p class="text-success">
                        <img src="images/successmsg.png"  />Members Was successfully created</p>
                </div>
            ...
            <div id="no-more-tables">
                <table class="table table-striped tab-text">
                        ...
                        <tbody id="divClassListing">
                            ...
                            ?>
                            <tr>
                                <td data-title="Name">&nbsp;<?php echo $reach['membername'];?></td>
                                <td data-title="Rollno">&nbsp;<?php echo $reach['rollno'] ;?></td>
                                <td data-title="position">&nbsp;<?php echo $reach['pos'];?></td>
                                <td data-title="About">&nbsp;<?php echo $reach['aboutme'];?></td>
                                
                                <td data-title="Action">
                                    
                                    <?php echo"<a href='form.php?id=".$reach['id_member1']."' class='edit' id='11'> edit</a>";?>
                                    <?php echo"<a href='deleteform.php?id=".$reach['id_member1']."' class='delete' id='11' >delete</a>";?>
