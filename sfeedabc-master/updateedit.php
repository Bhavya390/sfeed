            ...
            <div id="no-more-tables">
                <table class="table table-striped tab-text">
                        ...
                        <tbody id="divClassListing">
                            ...
                            ?>
                            <tr>
                                <td data-title="postcon">&nbsp;<?php echo $reach['PostCont'];?></td>
                                <td data-title="date">&nbsp;<?php echo $reach['PostDate'] ;?></td>
                                
                                
                                <td data-title="Action">
                                    
                                    <?php echo"<a href='updates.php?id=".$reach['pos_id']."' class='edit' id='11'> edit</a>";?>
                                    <?php echo"<a href='deleteupdates.php?id=".$reach['pos_id']."' class='edit' id='11'> delete</a>";?>
