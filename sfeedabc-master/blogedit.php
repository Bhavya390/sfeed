                ...
                <div class="col-sm-2 col-md-2 col-xs-12 heading">
                  ...
                  <div id="divmsg" style="display: none;" class="col-sm-7 col-md-5 col-xs-12 col-md-offset-2 hidden-xs">
                    <p class="text-success">
                        <img src="images/successmsg.png"  />Messages  is sent </p>
                </div>

                <div class="col-md-3 col-sm-3 col-xs-6 pull-right create_task text-right" id="createClass" >
                    <a href="scoreboard.php">Send A New Message</a>
                </div>
            </div>
                ...
                <table class="table table-striped tab-text">
                        ...
                        <tbody id="divClassListing">
                            ...
                            <?php
                                ...
                                $data = $users->dashboard($admin_id);
                                foreach($data as $reach)
                                {
                            ?>
                            <tr>
                                <td data-title="message">&nbsp;<?php echo $reach['messages'];?></td>
                    
                                
                                
                                <td data-title="Action">
                                    
                                    <?php echo"<a href='blog.php?id=".$reach['comment_id']."' class='edit' id='11'> edit</a>";?>
                                    <a href="javascript:void(0)" class="delete" id="11">Delete</a>
                                </td>
                            </tr>
                            <?php  }?>
                    </tbody>
