			...
			<div class="banner-navigation">
				<div class="banner-nav">
						<ul class="flexy-menu orange nav1">
							...
							<li class="hvr-sweep-to-bottom"><a href="#">News</a>
								<ul>
		...
		<div class="container">
			...
			<div class="banner-bottom-grids">
				<div class="col-md-3 banner-bottom-grid">
					<a href=""><img src="./images/<?=$sport.'1'?>.jpg" alt=" " /></a>
				...
				<div class="col-md-3 banner-bottom-grid">
					<a href="./matches.php?sport=<?=$sport?>"><img src="./images/<?=$sport.'2'?>.jpg" alt=" " /></a>
				...
				<div class="col-md-3 banner-bottom-grid">
					<a href="./squad.php?sport=<?=$sport?>"><img src="./images/<?=$sport.'3'?>.jpg" alt=" " /></a>
				...
				<div class="col-md-3 banner-bottom-grid">
					<a href="./gallery.php?sport=<?=$sport?>"><img src="./images/<?=$sport.'4'?>.jpg" alt=" " /></a>
